...
@EnableJpaRepositories(
        basePackages = "com.javaguides.EmployeeRepositoryManagement.repository", // Primary Repository package
...
public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory(
    ...
    return builder
            ...
            .packages("com.javaguides.EmployeeRepositoryManagement.entity")  // Package with Employee entities
